...
<td>[app.locals](https://expressjs.com/en/api.html#app.locals)</td>
...
<td>[app.all()](https://expressjs.com/en/api.html#app.all)</td>
...
<td>[app.delete()](https://expressjs.com/en/api.html#app.delete.method)</td>
...
<td>[app.engine()](https://expressjs.com/en/api.html#app.engine)</td>
...
<td>[app.get()](https://expressjs.com/en/api.html#app.get)</td>
...
<td>[app.listen()](https://expressjs.com/en/api.html#app.listen)</td>
...
<td>[app.post()](https://expressjs.com/en/api.html#app.post.method)</td>
...
<td>[app.put()](https://expressjs.com/en/api.html#app.put.method)</td>
...
<td>[req.body](http://expressjs.com/en/4x/api.html#req.body)</td>
...
<td>[req.cookies](http://expressjs.com/en/4x/api.html#req.cookies)</td>
...
<td>[req.params](http://expressjs.com/en/4x/api.html#req.params)</td>
...
<td>[req.query](http://expressjs.com/en/4x/api.html#req.query)</td>
...
<td>[req.get()](http://expressjs.com/en/4x/api.html#req.get)</td>
...
<td>[res.cookie()](http://expressjs.com/en/4x/api.html#res.cookie)</td>
...
<td>[res.download()](http://expressjs.com/en/4x/api.html#res.download)</td>
...
<td>[res.end()](http://expressjs.com/en/4x/api.html#res.end)</td>
...
<td>[res.get()](http://expressjs.com/en/4x/api.html#res.get)</td>
...
<td>[res.json()](http://expressjs.com/en/4x/api.html#res.json)</td>
...
<td>[res.redirect()](http://expressjs.com/en/4x/api.html#res.redirect)</td>
...
<td>[res.send()](http://expressjs.com/en/4x/api.html#res.send)</td>
...
<td>[res.status()](http://expressjs.com/en/4x/api.html#res.status)</td>
...
<td>[Application middleware](http://expressjs.com/en/guide/using-middleware.html#middleware.application)</td>
...
<td>[Router middleware](http://expressjs.com/en/guide/using-middleware.html#middleware.router)</td>
...
<td>[Error handling middleware](http://expressjs.com/en/guide/using-middleware.html#middleware.error-handling)</td>
...
<td>[Built in middleware](http://expressjs.com/en/guide/using-middleware.html#middleware.built-in)</td>
